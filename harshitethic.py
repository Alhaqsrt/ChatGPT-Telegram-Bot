...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "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"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'chatgpt Alhaq'
username = 'ChatGpt_Alhaqsrt_bot'
